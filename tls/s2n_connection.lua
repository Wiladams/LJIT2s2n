...
require("tls.s2n_tls_parameters")
require("tls.s2n_handshake")
require("tls.s2n_crypto")
require("tls.s2n_config")
require("tls.s2n_prf")

require("stuffer.s2n_stuffer")

require("crypto.s2n_hash")
require("crypto.s2n_hmac")

require("utils.s2n_mem")

local S2N_TLS_PROTOCOL_VERSION_LEN    = 2
local S2N_TLS_SESSION_ID_LEN          = 32
...
local exports = {
    S2N_TLS_PROTOCOL_VERSION_LEN = S2N_TLS_PROTOCOL_VERSION_LEN;
    S2N_TLS_SESSION_ID_LEN = S2N_TLS_SESSION_ID_LEN;

    -- data types
    s2n_connection = ffi.typeof("struct s2n_connection");
}
